-- AI Band: one-click import and rough-tone setup for the County Line Ghosts bent-lead sketch.

local DEFAULT_MIDI = "\\\\dees-workbench\\cloud-mirror\\ai-band\\examples\\county-line-ghosts-bent-lead.mid"
...
reaper.GetSetProjectInfo_String(0, "PROJECT_NAME", "AI Band - County Line Ghosts Bent Lead", true)
